...
import com.samet.artbookkotlinsamet.databinding.RecyclerRowBinding

class ArtAdapter (val artList: ArrayList<Art> = ArrayList<Art>()): RecyclerView.Adapter<ArtAdapter.ArtHolder>() {
